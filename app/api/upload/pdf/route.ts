// Upload PDF vers Shopify Files et retourne { url }
...
export async function POST(req: Request){
  try{
    ...
    const payload = { file: { attachment: buf, filename: file.name || `course-${Date.now()}.pdf`, content_type: file.type || 'application/pdf' } };
